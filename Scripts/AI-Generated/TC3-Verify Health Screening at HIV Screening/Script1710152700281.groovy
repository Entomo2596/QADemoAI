...
"Step 20: Click on button 'Continue'"
...
"Step 21: Click on input field '1 3.1'"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_hiv-screening/input_1_3_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/hiv-screening?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_hiv-screening/input_1_3_1'))
...
"Step 23: Click on input field '4.1.1.3'"
...
"Step 24: Click on input field '4.1.1.3.1'"
...
"Step 25: Enter input value in input field '4.1.1.3.1'"
...
"Step 26: Click on input field '4.1.1.3.2'"
...
"Step 27: Enter input value in input field '4.1.1.3.2'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Verify Health Screening at HIV Screening_visual_checkpoint')
