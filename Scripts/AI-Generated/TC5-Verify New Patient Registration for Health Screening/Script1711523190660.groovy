...
"Step 1: Navigate to https://mysjdev.entomo.co/hs/hajj/hajj-health-screening"
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_hajj_hajj_health_screening/hyperlink_add_new_health_screening'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/hajj/hajj-health-screening?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_hajj_hajj_health_screening/hyperlink_add_new_health_screening'))

"Step 4: Click on button 'Register New Patient'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Verify New Patient Registration for Health Screening_visual_checkpoint')
