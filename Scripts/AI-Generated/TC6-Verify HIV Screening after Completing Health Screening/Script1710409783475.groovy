...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_community_screening_community_screening_records/td_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/community-screening/community-screening-records?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_community_screening_community_screening_records/td_object'))
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_hiv_screening_hiv_screening_records/hyperlink_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/hiv-screening/hiv-screening-records?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_hiv_screening_hiv_screening_records/hyperlink_object'))
...
"Step 16: Click on input field '1 1.1.1'"
...
"Step 20: Click on input field '4.1.1.3'"
...
"Step 21: Click on input field '4.1.1.3.1'"
...
"Step 22: Enter input value in input field '4.1.1.3.1'"
...
"Step 23: Click on input field '4.1.1.3.2'"
...
"Step 24: Enter input value in input field '4.1.1.3.2'"
...
"Step 25: Click on button 'Continue'"
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_hiv_screening/button_continue_4'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/hiv-screening?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_hiv_screening/button_continue_4'))

"Step 27: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC6-Verify HIV Screening after Completing Health Screening_visual_checkpoint')
