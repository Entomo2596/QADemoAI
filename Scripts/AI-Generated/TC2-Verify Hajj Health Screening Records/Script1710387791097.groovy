...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_hiv-screening_hiv-screening-records/hyperlink_back_to_facility_medical_records'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/hiv-screening/hiv-screening-records?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_hiv-screening_hiv-screening-records/hyperlink_back_to_facility_medical_records'))

"Step 31: Click on link '\xa0\xa0Back to Facility Medical Records'"
...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_hajj_hajj-screening-records/button_object'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/hajj/hajj-screening-records?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_hajj_hajj-screening-records/button_object'))

"Step 33: Click on button"

WebUI.takeScreenshot()

WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_hajj_hajj-screening-records/button_object_1'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/hajj/hajj-screening-records?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_hajj_hajj-screening-records/button_object_1'))
...
"Step 35: Click on link '\xa0\xa0Back to Facility Medical Records' -> Navigate to page 'hs/hajj/hajj-screening-records'"
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC2-Verify Hajj Health Screening Records_visual_checkpoint')
