...
WebUI.verifyElementPresent(findTestObject('AI-Generated/Page_hs_health_screening/hyperlink_home'), 20, FailureHandling.CONTINUE_ON_FAILURE)

WebUI.verifyMatch(WebUI.getUrl(), GlobalVariable.application_domain + '/hs/health-screening?/?(?:#.*)?(?:\\?.*)?$', true)

WebUI.enhancedClick(findTestObject('AI-Generated/Page_hs_health_screening/hyperlink_home'))
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC13-Verify Hajj Hajj Screening Records after Accessing Health Screening Records_visual_checkpoint')
